...
async function main() {
  ...
  const rewardTemplates = [
    ...
    '🎉 Молодец! Ты победила таблеточку, теперь она внутри тебя работает на твое здоровье.',
    '👍 Супер! Самая красивая девушка на планете заботится о себе.',
    '⭐ Прекрасно! Я так рад, что ты выпила таблеточку.',
    '💪 Отличная работа! Ты сильная и ответственная, я люблю тебя.',
  ];
