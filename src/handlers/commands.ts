...
async function handleHelp(ctx: Context) {
    ...
    let helpText = '📚 *Команды Ultrathink:*\n\n' +
        '🔔 *Напоминания:*\n' +
        '• /setreminder <время> - Создать расписание\n' +
        ...
        '• /cancelquiz - Отменить квиз\n\n' +
        '📋 *Информация:*\n' +
        '• /whoami - Мой статус и ID\n' +
        '• /help - Справка\n\n' +
        '💡 *Формат времени:* HH:MM через запятую\n\n' +
        '🔄 *Режимы:*\n' +
        '• *Обычный:* Уведомления по расписанию\n' +
        '• *Последовательный:* Следующее после подтверждения';

    if (isAdminUser) {
        helpText += '\n\n👑 *Администрирование:*\n\n' +
            '📝 *Шаблоны:*\n' +
            '• /addreminder <текст> - Добавить напоминание\n' +
            '• /addreward <текст> - Добавить награду\n' +
            '• /deletemessage <id> - Удалить шаблон\n' +
            '• /listmessages [type] - Список шаблонов\n\n' +
            '👥 *Пользователи:*\n' +
            '• /setstatus <id> <статус> - Установить статус\n' +
            '• /clearstatus <id> - Удалить статус\n\n' +
            '🎯 *Квизы:*\n' +
            '• /createquiz <название> - Создать квиз\n' +
            '• /deletequiz <название> - Удалить квиз\n' +
            '• /addquestion <название> - Добавить вопрос\n' +
            '• /listquestions <название> - Показать вопросы\n' +
            '• /deletequestion <id> - Удалить вопрос\n' +
            '• /importquiz - Импортировать квиз';
    }
